<script>
  ...
  */
    ...
    function randomizeSphere() {
      ...
      rotationSpeed = Math.floor(Math.random() * 25) +10 ; // 5 to 30 seconds
      ...
      lines = Array.from({ length: lineCount }, () => ({
        ...
        rotationSpeed: Math.random() * 5 + 1 // 1 to 6 seconds
      }));
    }
  ...
  <div class="w-full h-full p-3 flex justify-center items-center overflow-hidden">
